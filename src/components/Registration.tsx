  ...
  return (
    <section className="registration" id="registration">
      <div className="section-inner reveal">
        ...
        <p className="section-lead">Early bird registration by May 15 receives a 20% discount. Payments are securely processed via PayPal — credit and debit cards accepted.</p>
        <div className="pricing-grid">
          <div className="pricing-card">
            <div className="pricing-tier">Regular</div>
            <div className="pricing-amount">$300</div>
            <div className="pricing-note">Early bird: $240</div>
            ...
            <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=YOUR_PAYPAL_BUTTON_ID_REGULAR" target="_blank" className="btn-paypal">
              <PayPalIcon /> Pay with PayPal
            </a>
            <div className="paypal-subtext">Credit &amp; debit cards accepted</div>
          </div>
          <div className="pricing-card featured">
            <div className="pricing-tier">Student</div>
            <div className="pricing-amount">$150</div>
            <div className="pricing-note">Early bird: $120</div>
            <ul className="pricing-features">
              <li>Full conference access</li>
              <li>All keynote sessions</li>
              <li>Conference materials</li>
            ...
            <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=YOUR_PAYPAL_BUTTON_ID_STUDENT" target="_blank" className="btn-paypal">
              <PayPalIcon /> Pay with PayPal
            </a>
            <div className="paypal-subtext">Credit &amp; debit cards accepted</div>
          </div>
          <div className="pricing-card">
            <div className="pricing-tier">WAHS Members</div>
            <div className="pricing-amount">Free</div>
            <div className="pricing-note">Membership benefits</div>
            <ul className="pricing-features">
              <li>Full conference access</li>
              <li>All keynote sessions</li>
              <li>Conference materials</li>
            ...
            <a href="mailto:wahskorea@gmail.com?subject=WAHS%20Member%20Registration%20-%20Congress%202026" className="btn-paypal btn-member">
              Register via Email
            </a>
            <div className="paypal-subtext">Verify membership to register</div>
          </div>
        </div>
