      ...
      <div className="admin-login-card">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <button
            ...
            style={{
              ...
              color: 'var(--slate)', fontSize: '0.88rem', fontWeight: 500,
        ...
        {sent ? (
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <h3 style={{ fontFamily: "'DM Serif Display', serif", fontSize: '1.2rem', marginBottom: 8, color: 'var(--navy)' }}>
              Check Your Email
            </h3>
            <p style={{ fontSize: '0.9rem', color: 'var(--slate)', lineHeight: 1.6 }}>
              A magic link has been sent to <strong>{sentEmail}</strong>.
              Click the link in the email to access the admin dashboard.
            </p>
            <p style={{ fontSize: '0.82rem', color: 'var(--mist)', marginTop: 12 }}>
              The link expires in 1 hour. Check your spam folder if you don&apos;t see it.
            </p>
            <Link
              href="/"
              style={{
                display: 'inline-block', marginTop: 20, fontSize: '0.88rem',
                color: 'var(--kr-blue)', textDecoration: 'none', fontWeight: 500,
              }}
            >
              ← Return to Home
            </Link>
              ...
              {error && (
                <div style={{ marginBottom: 16 }}>
                  ...
                  <p style={{ fontSize: '0.82rem', color: 'var(--mist)' }}>
                    Not an admin?{' '}
                    <Link href="/" style={{ color: 'var(--kr-blue)', fontWeight: 600 }}>
                      Go to Home →
                    </Link>
                  </p>
                </div>
