...
export default function CongressPage() {
  ...
  useEffect(() => {
    ...
    const urlYear = params?.year || '2026';
    setYear(urlYear.toString());
    
    // Update congress data with correct year
    const updatedCongress = {
      ...congressData,
      year: parseInt(urlYear.toString()),
      dates: `May 28–30, ${urlYear}`,
      submission_deadline: `March 31, ${urlYear}`,
      early_bird_deadline: `May 15, ${urlYear}`
    };
